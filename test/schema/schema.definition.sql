...
ALTER TABLE ONLY maevsi.event_favorite
    ADD CONSTRAINT event_favorite_event_id_fkey FOREIGN KEY (event_id) REFERENCES maevsi.address(id);
...
--
-- Name: event_favorite event_favorite_update; Type: POLICY; Schema: maevsi; Owner: postgres
--

CREATE POLICY event_favorite_update ON maevsi.event_favorite FOR UPDATE USING ((created_by = maevsi.invoker_account_id()));
