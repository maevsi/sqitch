...
COMMENT ON COLUMN vibetype.account_preference_event_location.id IS E'@omit create\nUnique identifier for the preference record.';
...
CREATE POLICY account_preference_event_location_all ON vibetype.account_preference_event_location FOR ALL
USING (
