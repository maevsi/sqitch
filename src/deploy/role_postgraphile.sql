...
DROP ROLE IF EXISTS :role_vibetype_postgraphile_username;
CREATE ROLE :role_vibetype_postgraphile_username LOGIN PASSWORD :'role_vibetype_postgraphile_password';
