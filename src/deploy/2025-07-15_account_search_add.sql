...
-- create idx_account_username_like on table vibetype.account, column username, using a trigram index as supported by the pg_trgm extension
...
-- create function account_search
...
-- grant execute privilege on function account_search
