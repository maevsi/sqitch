...
GRANT SELECT ON TABLE vibetype.profile_picture TO vibetype_account, vibetype_anonymous, vibetype_tusd;
GRANT INSERT, DELETE, UPDATE ON TABLE vibetype.profile_picture TO vibetype_account;
GRANT DELETE ON TABLE vibetype.profile_picture TO vibetype_tusd;
