...
DROP FUNCTION maevsi_test.create_event_category (TEXT);
DROP FUNCTION maevsi_test.create_event_category_mapping (UUID, UUID, TEXT);
...
DROP FUNCTION maevsi_test.select_event_category_mappings (TEXT, TEXT, UUID, UUID[]);
